...
export default function Footer() {
  ...
  const services = [
    { name: 'Basement Remodeling', href: '/services/home-remodeling/basement-remodeling' },
    { name: 'Bathroom Remodeling', href: '/services/home-remodeling/bathroom-remodeling' },
    { name: 'Kitchen Remodeling', href: '/services/home-remodeling/kitchen-remodeling' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              Professional construction services for your home renovation and custom construction projects. 
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-gray-400 text-sm text-center md:text-right">
              © {new Date().getFullYear()} Shearer Carpentry. All rights reserved.
            </p>
          </div>
        </motion.div>
      </div>
