  ...
  const services = [
    {
      ...
      description: 'Optimize your basement\'s layout by moving or rearranging walls to create a more functional space.',
      color: 'from-blue-500 to-blue-600',
    },
    {
      icon: Layout,
      title: 'Designing Spaces',
      description: 'We help design practical and attractive layouts for your basement, tailored to your needs.',
      color: 'from-green-500 to-green-600',
    },
    {
      icon: Phone,
      title: 'Warranty Calls About Water Damage',
      description: 'We handle all insurance work for water damage claims, navigating the process so you can take full advantage of your insurance without worry.',
      color: 'from-purple-500 to-purple-600',
    },
    {
      icon: Layers,
      title: 'Flooring Installation',
      description: 'Choose from a variety of flooring options to enhance the comfort and appearance of your basement.',
      color: 'from-orange-500 to-orange-600',
    },
    {
      icon: Lightbulb,
      title: 'Lighting Solutions',
      description: 'Improve the ambiance and functionality of your basement with our expert lighting installations.',
      color: 'from-yellow-500 to-yellow-600',
    },
    {
      icon: Droplets,
      title: 'Insulation and Waterproofing',
      description: 'Ensure your basement is warm, dry, and energy-efficient with our insulation and waterproofing services.',
  ...
  const problemSigns = [
    {
      icon: AlertTriangle,
      title: 'Water Damage',
      description: 'Stains, mold, or mildew indicate water damage that needs addressing.',
    },
    {
      icon: Wind,
      title: 'Poor Insulation',
      description: 'Cold drafts and high energy bills may signal inadequate insulation.',
    },
    {
      icon: Settings,
      title: 'Outdated Design',
      description: 'An old or impractical layout can make your basement less functional.',
    },
    {
      icon: AlertTriangle,
      title: 'Structural Issues',
      description: 'Cracks in walls or floors can point to structural problems that need fixing.',
    },
    {
      icon: Droplets,
      title: 'Damp or Musty Smell',
      description: 'Persistent odors can be a sign of moisture issues or mold growth.',
    },
    {
      icon: Lightbulb,
      title: 'Inadequate Lighting',
      description: 'A dark, poorly lit basement can benefit from a lighting upgrade.',
    },
  ];
            ...
            >
                <div className="space-y-6">
                  <p className="text-lg text-gray-600 leading-relaxed">
                    At Shearer Carpentry, we offer a range of design options to suit your needs. We can help you design the space or collaborate with designers to bring your vision to life. Whether you want a cozy family room, a home office, or an entertainment area, we have the expertise to make it happen.
                  </p>
                  
                  <p className="text-gray-600 leading-relaxed">
                    We specialize in transforming underutilized basement spaces into beautiful, functional areas that add significant value to your home. Our comprehensive approach includes everything from structural modifications and electrical work to finishing touches that make your basement feel like a natural extension of your living space.
                  </p>

                  <p className="text-gray-600 leading-relaxed">
                    Quality craftsmanship and attention to detail are at the heart of everything we do. We use only the finest materials and employ time-tested construction techniques to ensure your basement remodeling project stands the test of time. Our commitment to excellence has earned us a reputation as one of the most trusted contractors in the Plymouth area.
                  </p>
                </div>
            </motion.div>
